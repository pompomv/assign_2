...
<head>
    ...
    <style>
        ...
        .hero {
            background: url('assets/img/physics.png') center/cover no-repeat;
            color: white;
            text-align: center;
            padding: 100px 20px;
            animation: fadeIn 2s;
...
<body>
    ...
    <div class="hero">
        <h1>Kursus Fisika</h1>
        <p>Pahami prinsip dasar fisika untuk memahami dunia lebih dalam!</p>
    </div>

    <div class="container mt-5">
        <div class="row text-center">
            <div class="col-md-4">
                <i class="fa-solid fa-atom fa-3x text-primary"></i>
                <h4>Fisika Kuantum</h4>
                <p>Pelajari konsep kuantum dan aplikasinya dalam dunia modern.</p>
            </div>
            <div class="col-md-4">
                <i class="fa-solid fa-bolt fa-3x text-success"></i>
                <h4>Listrik & Energi</h4>
                <p>Pahami prinsip listrik, magnet, dan energi dalam kehidupan sehari-hari.</p>
            </div>
            <div class="col-md-4">
                <i class="fa-solid fa-globe fa-3x text-danger"></i>
                <h4>Hukum Alam</h4>
                <p>Kenali hukum-hukum fisika yang mengatur alam semesta.</p>
            </div>
        </div>
    </div>

    <div class="container mt-5">
        <h2 class="text-center">Mengapa Belajar Fisika Itu Penting?</h2>
        <p class="text-center">
            Fisika adalah ilmu yang menjelaskan bagaimana dunia ini bekerja, dari partikel terkecil hingga fenomena alam yang kompleks. 
            Dengan memahami konsep-konsep fisika seperti gerak, energi, listrik, dan gelombang, kita dapat menerapkan pengetahuan ini dalam teknologi, rekayasa, dan kehidupan sehari-hari.
        </p>
        <p class="text-center">
            Di SkillXpert, kami menyediakan pembelajaran fisika yang sistematis dan mudah dipahami, menggunakan metode eksperimen, simulasi, dan latihan soal. 
            Dengan bimbingan instruktur berpengalaman, Anda dapat menguasai dasar-dasar fisika serta konsep tingkat lanjut dengan cara yang lebih menyenangkan dan praktis.
        </p>
    </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card pricing-card">
                    <div class="card-body text-center">
                        <h3>Pemula</h3>
                        <p><i class="fa-solid fa-star text-warning"></i> Dasar Fisika</p>
            ...
            <div class="col-md-4">
                <div class="card pricing-card">
                    <div class="card-body text-center">
                        <h3>Menengah</h3>
                        <p><i class="fa-solid fa-star text-warning"></i> Mekanika & Listrik</p>
